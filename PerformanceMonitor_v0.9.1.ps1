...
function Apply-AdaptiveFilter {
    ...
    # SELEÇÃO DE FILTRO (DEMA E HYSTERESIS APENAS)
    if ($Global:ConfigData.AdaptiveDema) {
        $alpha = 0.45
        ...
        if ($diff -lt 3 -and $Result -ne 0 -and $Result -ne 100) { $Result = $LastRef.Value } else { $LastRef.Value = $Result }
    }
...
function Show-AdvancedSettings {
    # 1. JANELA BLINDADA COMPACTADA (CAMINHO 2)
    $frmAdv = New-Object System.Windows.Forms.Form; $frmAdv.Size = New-Object System.Drawing.Size(920, 440); $frmAdv.StartPosition = "CenterScreen"; $frmAdv.TopMost = $true; 
    $frmAdv.FormBorderStyle = "None"; 
    $frmAdv.BackColor = [System.Drawing.Color]::DimGray 
    ...
    # --- MAIN CONTENT PANEL ---
    $pnlAdvContent = New-Object System.Windows.Forms.Panel; $pnlAdvContent.Size = "918, 409"; $pnlAdvContent.Location = "1, 30"; $pnlAdvContent.BackColor = [System.Drawing.Color]::WhiteSmoke; $frmAdv.Controls.Add($pnlAdvContent)

    $lblFreqInfo = New-Object System.Windows.Forms.Label; $lblFreqInfo.Text = "Fixed Data Collection Frequency: 300ms"; $lblFreqInfo.Location = "10, 15"; $lblFreqInfo.AutoSize = $true; $lblFreqInfo.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel); $lblFreqInfo.ForeColor = [System.Drawing.Color]::DarkSlateBlue; $pnlAdvContent.Controls.Add($lblFreqInfo)
    ...
    # PIPELINE GROUP (MOVIDO PARA CIMA)
    $grpM = New-Object System.Windows.Forms.GroupBox; $grpM.Text = "Filtering Method (Pipeline):"; $grpM.Location = "10, 230"; $grpM.Size = "880, 100" 
    ...
    $btnHelp.Add_Click({ 
        ...
        $pnlHelpContent = New-Object System.Windows.Forms.Panel; $pnlHelpContent.Size = "598, 269"; $pnlHelpContent.Location = "1, 30"; $pnlHelpContent.BackColor = [System.Drawing.Color]::WhiteSmoke; $frmHelp.Controls.Add($pnlHelpContent)
        $lblMsg = New-Object System.Windows.Forms.Label; $lblMsg.Text = "1. DEMA (Double Exponential Moving Average)`nHow it works: It provides a result that is smooth like the average but reacts much faster to sudden changes.`n`n2. Hysteresis (Noise Filter)`nHow it works: It's like a rigid 'doorman'. It looks at the new value and compares it with the old one. If the difference is less than 3%, it ignores the change and keeps the old number on the screen."
        $lblMsg.Location = "20, 20"; $lblMsg.Size = "560, 180"; $lblMsg.AutoSize = $false; $lblMsg.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel); $pnlHelpContent.Controls.Add($lblMsg)
        $btnHelpOk = New-Object System.Windows.Forms.Button; $btnHelpOk.Text = "OK"; $btnHelpOk.Location = "240, 210"; $btnHelpOk.Size = "120, 30"; $btnHelpOk.BackColor = [System.Drawing.Color]::DodgerBlue; $btnHelpOk.ForeColor = [System.Drawing.Color]::White; $btnHelpOk.FlatStyle = "Flat"; $btnHelpOk.Add_Click({ $frmHelp.Close() }); $pnlHelpContent.Controls.Add($btnHelpOk)
        [void]$frmHelp.ShowDialog()
    })
    $grpM.Controls.Add($btnHelp)

    $chkM5 = New-Object System.Windows.Forms.CheckBox; $chkM5.Text = "DEMA"; $chkM5.Location = "20, 25"; $chkM5.AutoSize = $true; $chkM5.Checked = $Global:ConfigData.AdaptiveDema; $chkM5.FlatStyle = "System"; $grpM.Controls.Add($chkM5)
    $lblM5 = New-Object System.Windows.Forms.Label; $lblM5.Text = "(High Precision, Low Latency / Low Smoothing)"; $lblM5.Location = "150, 26"; $lblM5.AutoSize = $true; $lblM5.Font = New-Object System.Drawing.Font("Segoe UI", 11, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel); $lblM5.ForeColor = [System.Drawing.Color]::DimGray; $grpM.Controls.Add($lblM5)
    
    $chkM4 = New-Object System.Windows.Forms.CheckBox; $chkM4.Text = "Hysteresis"; $chkM4.Location = "20, 50"; $chkM4.AutoSize = $true; $chkM4.Checked = $Global:ConfigData.AdaptiveHysteresis; $chkM4.FlatStyle = "System"; $grpM.Controls.Add($chkM4)
    $lblM4 = New-Object System.Windows.Forms.Label; $lblM4.Text = "(Low Latency / Precision and smoothing may vary)"; $lblM4.Location = "150, 51"; $lblM4.AutoSize = $true; $lblM4.Font = New-Object System.Drawing.Font("Segoe UI", 11, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel); $lblM4.ForeColor = [System.Drawing.Color]::DimGray; $grpM.Controls.Add($lblM4)

    $pnlAdvContent.Controls.Add($grpM)

    $chkM5.Add_Click({ if ($chkM5.Checked) { $chkM4.Checked=$false } })
    $chkM4.Add_Click({ if ($chkM4.Checked) { $chkM5.Checked=$false } })

    # BOTÕES (SUBIRAM)
    $btnCancel = New-Object System.Windows.Forms.Button; $btnCancel.Text = "Cancel"; $btnCancel.Location = "330, 350"; $btnCancel.Size = "130, 30"; $btnCancel.BackColor = [System.Drawing.Color]::Firebrick; $btnCancel.ForeColor = [System.Drawing.Color]::White; $btnCancel.FlatStyle = "Flat"; $btnCancel.Add_Click({ $frmAdv.Close() }); $pnlAdvContent.Controls.Add($btnCancel)
    $btnOk = New-Object System.Windows.Forms.Button; $btnOk.Text = "Done"; $btnOk.Location = "480, 350"; $btnOk.Size = "130, 30"; $btnOk.BackColor = [System.Drawing.Color]::LightGray; $btnOk.ForeColor = [System.Drawing.Color]::Gray; $btnOk.FlatStyle = "Flat"; $btnOk.Enabled = $false
    ...
    $ValidateForm = {
        ...
        $mainFilterSelected = ($chkM4.Checked -or $chkM5.Checked)
    ...
    $chkM4.Add_CheckedChanged($ValidateForm); $chkM5.Add_CheckedChanged($ValidateForm)
    & $ValidateForm
    ...
    $btnOk.Add_Click({
        ...
        $Global:ConfigData.AdaptiveDema = $chkM5.Checked; $Global:ConfigData.AdaptiveHysteresis = $chkM4.Checked
        ...
        $lblDoneMsg = New-Object System.Windows.Forms.Label; $lblDoneMsg.Text = "Settings applied! Click 'SAVE CONFIGURATION' to keep them.`nAdaptive frequency locked to 300ms."; $lblDoneMsg.Location = "20, 20"; $lblDoneMsg.Size = "360, 40"; $lblDoneMsg.AutoSize = $false; $pnlDoneContent.Controls.Add($lblDoneMsg)
